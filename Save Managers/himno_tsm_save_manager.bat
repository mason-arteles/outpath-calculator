...
IF NOT EXIST "%APPDATA%/../LocalLow/Breakfast Studio/Himno The Silent Melody" (
...
:CASE_SAVE
    ...
    FOR /F "tokens=2*" %%A %%B IN (%ARGS%) DO (
        ...
        COPY "./SaveFile%FILE_SLOT%.es3" "./Backups/%%A.es3"
    )
    CALL NEXT_ARG
